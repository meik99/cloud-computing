...
If they succeed, a job uploads a new docker image of the demo app to Docker Hub. In addition, Discord notifications inform the developer about certain events (e.g. test failure).
